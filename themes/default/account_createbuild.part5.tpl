<script type="text/javascript">
	  ...
	  {
		$('img').bind("contextmenu", function(e){ return false; }) // Resimlere sağ tıklayınca resim penceresini açma, skill puanını sil
	  });
</script>
...
$('.box').mousedown( function(el) 
{
	...
	<br>
	<button id="doStep5" class="ui-button button1"> 
		<span class="button-left">
			<span class="button-right">6. adıma geç...</span>
		</span>
	</button>
	</form>
</div>